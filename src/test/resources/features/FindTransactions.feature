...
Feature:Find Transactionsin Account Activity
  ...
  And the results table should only not contain transactionsdated "2012-09-01"
  ...
  But results table should notshow descriptions containing "OFFICE"
  ...
  And the user accesses the Find Transactions tab
    ...
    When user selects type "Deposit"Then results table should show at least one result under Deposit
